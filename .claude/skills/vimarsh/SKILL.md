...
`claude` from). Create directories as needed.
...
- Answer → `.claude/skills/vimarsh/rubrics/answer-rubric.md`
- Essay → `.claude/skills/vimarsh/rubrics/essay-rubric.md`
...
`.claude/skills/vimarsh/followup.md`. Stay consistent with the scores you gave.
